...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    public partial class Employee :  IEquatable<Employee>, IValidatableObject
    {
        ...
        public Employee(string Id = default(string), TypeEnum? Type = default(TypeEnum?), InlineResponse200Meta Meta = default(InlineResponse200Meta), InlineResponse2007Attributes Attributes = default(InlineResponse2007Attributes), InlineResponse2007Relationships Relationships = default(InlineResponse2007Relationships))
        {
            this.Id = Id;
            this.Type = Type;
            this.Meta = Meta;
