...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EDocumentPdf :  IEquatable<EDocumentPdf>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Pdfs for "e_document_pdfs"
            /// </summary>
            [EnumMember(Value = "e_document_pdfs")]
            Pdfs
        }
        ...
        public InlineResponse2004DataAttributes Attributes { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EDocumentPdf);
        }

        /// <summary>
        /// Returns true if EDocumentPdf instances are equal
        /// </summary>
        /// <param name="other">Instance of EDocumentPdf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EDocumentPdf other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
