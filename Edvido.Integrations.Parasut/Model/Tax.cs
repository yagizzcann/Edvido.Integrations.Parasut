...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    public partial class Tax :  IEquatable<Tax>, IValidatableObject
    {
        ...
        public Tax(string Id = default(string), TypeEnum? Type = default(TypeEnum?), InlineResponse200Meta Meta = default(InlineResponse200Meta), CompanyIdtaxesDataAttributes Attributes = default(CompanyIdtaxesDataAttributes), CompanyIdbankFeesDataRelationships Relationships = default(CompanyIdbankFeesDataRelationships))
        {
            this.Id = Id;
            this.Type = Type;
            this.Meta = Meta;
