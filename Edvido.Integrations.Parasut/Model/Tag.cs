...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    public partial class Tag :  IEquatable<Tag>, IValidatableObject
    {
        ...
        public Tag(string Id = default(string), TypeEnum? Type = default(TypeEnum?), InlineResponse200Meta Meta = default(InlineResponse200Meta), InlineResponse20011Attributes Attributes = default(InlineResponse20011Attributes))
        {
            this.Id = Id;
            this.Type = Type;
            this.Meta = Meta;
