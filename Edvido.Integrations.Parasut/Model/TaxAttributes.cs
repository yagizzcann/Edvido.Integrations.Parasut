...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaxAttributes :  IEquatable<TaxAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaxAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TaxAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TaxAttributes" /> class.
        /// </summary>
        ...
        public TaxAttributes(string Description = default(string), DateTime? IssueDate = default(DateTime?), DateTime? DueDate = default(DateTime?), decimal? NetTotal = default(decimal?))
        {
            // to ensure "Description" is required (not null)
            if (Description == null)
            {
                throw new InvalidDataException("Description is a required property for TaxAttributes and cannot be null");
            }
            else
            {
            ...
            if (IssueDate == null)
            {
                throw new InvalidDataException("IssueDate is a required property for TaxAttributes and cannot be null");
            }
            else
            {
            ...
            if (DueDate == null)
            {
                throw new InvalidDataException("DueDate is a required property for TaxAttributes and cannot be null");
            }
            else
            {
            ...
            if (NetTotal == null)
            {
                throw new InvalidDataException("NetTotal is a required property for TaxAttributes and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TaxAttributes);
        }

        /// <summary>
        /// Returns true if TaxAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of TaxAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
