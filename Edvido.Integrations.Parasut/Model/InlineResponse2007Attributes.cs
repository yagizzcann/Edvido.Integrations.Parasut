...
{
    /// <summary>
    /// InlineResponse2007Attributes
    /// </summary>
    [DataContract]
    public partial class InlineResponse2007Attributes :  IEquatable<InlineResponse2007Attributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Attributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2007Attributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Attributes" /> class.
        /// </summary>
        ...
        public InlineResponse2007Attributes(string Name = default(string), string Email = default(string), bool? Archived = default(bool?), string Iban = default(string))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for InlineResponse2007Attributes and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007Attributes {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2007Attributes);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Attributes instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2007Attributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Attributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
