...
{
    /// <summary>
    /// CompanyIdbankFeesidpaymentsDataAttributes
    /// </summary>
    [DataContract]
    public partial class CompanyIdbankFeesidpaymentsDataAttributes :  IEquatable<CompanyIdbankFeesidpaymentsDataAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdbankFeesidpaymentsDataAttributes" /> class.
        /// </summary>
        ...
        public CompanyIdbankFeesidpaymentsDataAttributes(string Description = default(string), int? AccountId = default(int?), DateTime? Date = default(DateTime?), decimal? Amount = default(decimal?), decimal? ExchangeRate = default(decimal?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdbankFeesidpaymentsDataAttributes {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyIdbankFeesidpaymentsDataAttributes);
        }

        /// <summary>
        /// Returns true if CompanyIdbankFeesidpaymentsDataAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyIdbankFeesidpaymentsDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdbankFeesidpaymentsDataAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
