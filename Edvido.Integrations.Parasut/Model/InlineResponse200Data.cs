...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    public partial class InlineResponse200Data :  IEquatable<InlineResponse200Data>, IValidatableObject
    {
        ...
        public InlineResponse200Data(string Id = default(string), TypeEnum? Type = default(TypeEnum?), InlineResponse200Meta Meta = default(InlineResponse200Meta), InlineResponse200Attributes Attributes = default(InlineResponse200Attributes))
        {
            this.Id = Id;
            this.Type = Type;
            this.Meta = Meta;
