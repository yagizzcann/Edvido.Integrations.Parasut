...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactPaymentForm :  IEquatable<ContactPaymentForm>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactPaymentForm {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContactPaymentForm);
        }

        /// <summary>
        /// Returns true if ContactPaymentForm instances are equal
        /// </summary>
        /// <param name="other">Instance of ContactPaymentForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactPaymentForm other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
