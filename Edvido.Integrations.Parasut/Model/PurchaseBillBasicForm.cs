...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseBillBasicForm :  IEquatable<PurchaseBillBasicForm>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillBasicForm {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PurchaseBillBasicForm);
        }

        /// <summary>
        /// Returns true if PurchaseBillBasicForm instances are equal
        /// </summary>
        /// <param name="other">Instance of PurchaseBillBasicForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillBasicForm other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
