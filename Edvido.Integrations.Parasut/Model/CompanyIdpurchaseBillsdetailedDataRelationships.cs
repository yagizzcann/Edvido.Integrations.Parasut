...
{
    /// <summary>
    /// CompanyIdpurchaseBillsdetailedDataRelationships
    /// </summary>
    [DataContract]
    public partial class CompanyIdpurchaseBillsdetailedDataRelationships :  IEquatable<CompanyIdpurchaseBillsdetailedDataRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        public CompanyIdpurchaseBillsdetailedDataRelationshipsDetails Details { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdpurchaseBillsdetailedDataRelationships {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyIdpurchaseBillsdetailedDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsdetailedDataRelationships instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyIdpurchaseBillsdetailedDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsdetailedDataRelationships other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
