...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemCategory :  IEquatable<ItemCategory>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ItemCategory);
        }

        /// <summary>
        /// Returns true if ItemCategory instances are equal
        /// </summary>
        /// <param name="other">Instance of ItemCategory to be compared</param>
        /// <returns>Boolean</returns>
