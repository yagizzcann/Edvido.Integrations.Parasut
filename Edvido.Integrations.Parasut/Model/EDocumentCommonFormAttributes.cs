...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EDocumentCommonFormAttributes :  IEquatable<EDocumentCommonFormAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EDocumentCommonFormAttributes" /> class.
        /// </summary>
        ...
        public EDocumentCommonFormAttributes(string VatWithholdingCode = default(string), string VatExemptionReasonCode = default(string), string VatExemptionReason = default(string), string Note = default(string), List<CompanyIdeArchivesDataAttributesExciseDutyCodes> ExciseDutyCodes = default(List<CompanyIdeArchivesDataAttributesExciseDutyCodes>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EDocumentCommonFormAttributes {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EDocumentCommonFormAttributes);
        }

        /// <summary>
        /// Returns true if EDocumentCommonFormAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of EDocumentCommonFormAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EDocumentCommonFormAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
