...
{
    /// <summary>
    /// CompanyIdcontactsidcontactDebitTransactionsDataAttributes
    /// </summary>
    [DataContract]
    public partial class CompanyIdcontactsidcontactDebitTransactionsDataAttributes :  IEquatable<CompanyIdcontactsidcontactDebitTransactionsDataAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdcontactsidcontactDebitTransactionsDataAttributes" /> class.
        /// </summary>
        ...
        public CompanyIdcontactsidcontactDebitTransactionsDataAttributes(string Description = default(string), int? AccountId = default(int?), DateTime? Date = default(DateTime?), decimal? Amount = default(decimal?), decimal? ExchangeRate = default(decimal?), List<int?> PayableIds = default(List<int?>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdcontactsidcontactDebitTransactionsDataAttributes {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyIdcontactsidcontactDebitTransactionsDataAttributes);
        }

        /// <summary>
        /// Returns true if CompanyIdcontactsidcontactDebitTransactionsDataAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyIdcontactsidcontactDebitTransactionsDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdcontactsidcontactDebitTransactionsDataAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
