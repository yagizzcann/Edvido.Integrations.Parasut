...
{
    /// <summary>
    /// CompanyIdpurchaseBillsdetailedDataAttributes
    /// </summary>
    [DataContract]
    public partial class CompanyIdpurchaseBillsdetailedDataAttributes :  IEquatable<CompanyIdpurchaseBillsdetailedDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdpurchaseBillsdetailedDataAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompanyIdpurchaseBillsdetailedDataAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdpurchaseBillsdetailedDataAttributes" /> class.
        /// </summary>
        ...
        public CompanyIdpurchaseBillsdetailedDataAttributes(ItemTypeEnum? ItemType = default(ItemTypeEnum?), string Description = default(string), DateTime? IssueDate = default(DateTime?), DateTime? DueDate = default(DateTime?), string InvoiceNo = default(string), CurrencyEnum? Currency = default(CurrencyEnum?), decimal? ExchangeRate = default(decimal?), decimal? WithholdingRate = default(decimal?), decimal? VatWithholdingRate = default(decimal?), decimal? InvoiceDiscount = default(decimal?), InvoiceDiscountTypeEnum? InvoiceDiscountType = default(InvoiceDiscountTypeEnum?))
        {
            ...
            if (IssueDate == null)
            {
                throw new InvalidDataException("IssueDate is a required property for CompanyIdpurchaseBillsdetailedDataAttributes and cannot be null");
            }
            else
            {
            ...
            if (DueDate == null)
            {
                throw new InvalidDataException("DueDate is a required property for CompanyIdpurchaseBillsdetailedDataAttributes and cannot be null");
            }
            else
            {
            ...
            if (Currency == null)
            {
                throw new InvalidDataException("Currency is a required property for CompanyIdpurchaseBillsdetailedDataAttributes and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdpurchaseBillsdetailedDataAttributes {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyIdpurchaseBillsdetailedDataAttributes);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsdetailedDataAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyIdpurchaseBillsdetailedDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsdetailedDataAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
