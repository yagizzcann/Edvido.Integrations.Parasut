...
{
    /// <summary>
    /// CompanyIdaccountsData
    /// </summary>
    [DataContract]
    public partial class CompanyIdaccountsData :  IEquatable<CompanyIdaccountsData>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponse200Attributes Attributes { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdaccountsData {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyIdaccountsData);
        }

        /// <summary>
        /// Returns true if CompanyIdaccountsData instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyIdaccountsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdaccountsData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
