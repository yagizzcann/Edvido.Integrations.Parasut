...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BankFeeAttributes :  IEquatable<BankFeeAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BankFeeAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BankFeeAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BankFeeAttributes" /> class.
        /// </summary>
        ...
        public BankFeeAttributes(string Description = default(string), CurrencyEnum? Currency = default(CurrencyEnum?), DateTime? IssueDate = default(DateTime?), DateTime? DueDate = default(DateTime?), decimal? ExchangeRate = default(decimal?), decimal? NetTotal = default(decimal?))
        {
            // to ensure "Description" is required (not null)
            if (Description == null)
            {
                throw new InvalidDataException("Description is a required property for BankFeeAttributes and cannot be null");
            }
            else
            {
            ...
            if (Currency == null)
            {
                throw new InvalidDataException("Currency is a required property for BankFeeAttributes and cannot be null");
            }
            else
            {
            ...
            if (IssueDate == null)
            {
                throw new InvalidDataException("IssueDate is a required property for BankFeeAttributes and cannot be null");
            }
            else
            {
            ...
            if (DueDate == null)
            {
                throw new InvalidDataException("DueDate is a required property for BankFeeAttributes and cannot be null");
            }
            else
            {
            ...
            if (NetTotal == null)
            {
                throw new InvalidDataException("NetTotal is a required property for BankFeeAttributes and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BankFeeAttributes {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BankFeeAttributes);
        }

        /// <summary>
        /// Returns true if BankFeeAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of BankFeeAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankFeeAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
