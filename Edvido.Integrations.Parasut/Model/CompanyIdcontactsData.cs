...
{
    /// <summary>
    /// CompanyIdcontactsData
    /// </summary>
    [DataContract]
    public partial class CompanyIdcontactsData :  IEquatable<CompanyIdcontactsData>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponse2002Attributes Attributes { get; set; }
        /// <summary>
        /// Gets or Sets Relationships
        /// </summary>
        [DataMember(Name="relationships", EmitDefaultValue=false)]
        public CompanyIdcontactsDataRelationships Relationships { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdcontactsData {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyIdcontactsData);
        }

        /// <summary>
        /// Returns true if CompanyIdcontactsData instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyIdcontactsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdcontactsData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
