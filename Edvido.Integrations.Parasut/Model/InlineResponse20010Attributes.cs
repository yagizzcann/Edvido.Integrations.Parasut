...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    public partial class InlineResponse20010Attributes :  IEquatable<InlineResponse20010Attributes>, IValidatableObject
    {
        ...
        public InlineResponse20010Attributes(ItemTypeEnum? ItemType = default(ItemTypeEnum?), string Description = default(string),
            DateTime? IssueDate = default(DateTime?), DateTime? DueDate = default(DateTime?), string InvoiceSeries = default(string),
            int? InvoiceId = default(int?), CurrencyEnum? Currency = default(CurrencyEnum?), decimal? ExchangeRate = default(decimal?),
            decimal? WithholdingRate = default(decimal?), decimal? VatWithholdingRate = default(decimal?)
            , InvoiceDiscountTypeEnum? InvoiceDiscountType = default(InvoiceDiscountTypeEnum?),
            decimal? InvoiceDiscount = default(decimal?), string BillingAddress = default(string), 
            string BillingPhone = default(string), string BillingFax = default(string), 
            string TaxOffice = default(string), string TaxNumber = default(string), 
            string City = default(string), string District = default(string),
            string IsAbroad = default(string), string OrderNo = default(string), DateTime? OrderDate = default(DateTime?),
            string ShipmentAddres = default(string)   , bool ShipmentIncluded = default(bool))
        {
