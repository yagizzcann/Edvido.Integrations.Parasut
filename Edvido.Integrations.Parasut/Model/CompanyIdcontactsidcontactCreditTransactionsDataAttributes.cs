...
{
    /// <summary>
    /// CompanyIdcontactsidcontactCreditTransactionsDataAttributes
    /// </summary>
    [DataContract]
    public partial class CompanyIdcontactsidcontactCreditTransactionsDataAttributes :  IEquatable<CompanyIdcontactsidcontactCreditTransactionsDataAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdcontactsidcontactCreditTransactionsDataAttributes" /> class.
        /// </summary>
        ...
        public CompanyIdcontactsidcontactCreditTransactionsDataAttributes(string Description = default(string), int? AccountId = default(int?), DateTime? Date = default(DateTime?), decimal? Amount = default(decimal?), decimal? ExchangeRate = default(decimal?), List<int?> PayableIds = default(List<int?>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdcontactsidcontactCreditTransactionsDataAttributes {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyIdcontactsidcontactCreditTransactionsDataAttributes);
        }

        /// <summary>
        /// Returns true if CompanyIdcontactsidcontactCreditTransactionsDataAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyIdcontactsidcontactCreditTransactionsDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdcontactsidcontactCreditTransactionsDataAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
