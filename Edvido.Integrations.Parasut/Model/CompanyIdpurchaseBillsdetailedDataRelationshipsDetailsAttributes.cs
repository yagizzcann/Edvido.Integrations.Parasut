...
{
    /// <summary>
    /// CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes
    /// </summary>
    [DataContract]
    public partial class CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes :  IEquatable<CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes" /> class.
        /// </summary>
        ...
        public CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes(decimal? Quantity = default(decimal?), decimal? UnitPrice = default(decimal?), decimal? VatRate = default(decimal?), DiscountTypeEnum? DiscountType = default(DiscountTypeEnum?), decimal? DiscountValue = default(decimal?), ExciseDutyTypeEnum? ExciseDutyType = default(ExciseDutyTypeEnum?), decimal? ExciseDutyValue = default(decimal?), decimal? CommunicationsTaxRate = default(decimal?), string Description = default(string))
        {
            ...
            if (UnitPrice == null)
            {
                throw new InvalidDataException("UnitPrice is a required property for CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes and cannot be null");
            }
            else
            {
            ...
            if (VatRate == null)
            {
                throw new InvalidDataException("VatRate is a required property for CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
