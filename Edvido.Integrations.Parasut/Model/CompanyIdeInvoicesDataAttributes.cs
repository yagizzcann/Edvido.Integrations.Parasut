...
{
    /// <summary>
    /// CompanyIdeInvoicesDataAttributes
    /// </summary>
    [DataContract]
    public partial class CompanyIdeInvoicesDataAttributes :  IEquatable<CompanyIdeInvoicesDataAttributes>, IValidatableObject
    {
        /// <summary>
        /// Gönderim senaryosu
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdeInvoicesDataAttributes" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdeInvoicesDataAttributes {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyIdeInvoicesDataAttributes);
        }

        /// <summary>
        /// Returns true if CompanyIdeInvoicesDataAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyIdeInvoicesDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdeInvoicesDataAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
