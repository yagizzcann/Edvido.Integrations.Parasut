...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrackableJob :  IEquatable<TrackableJob>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrackableJob);
        }

        /// <summary>
        /// Returns true if TrackableJob instances are equal
        /// </summary>
        /// <param name="other">Instance of TrackableJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackableJob other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
