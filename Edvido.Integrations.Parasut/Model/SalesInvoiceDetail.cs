...
namespace Edvido.Integrations.Parasut.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesInvoiceDetail :  IEquatable<SalesInvoiceDetail>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SalesInvoiceDetail);
        }

        /// <summary>
        /// Returns true if SalesInvoiceDetail instances are equal
        /// </summary>
        /// <param name="other">Instance of SalesInvoiceDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceDetail other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
